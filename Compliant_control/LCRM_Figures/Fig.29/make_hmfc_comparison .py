...
load_1 = '/home/martin/Figures master/data from runs/no training/hmfc_simple_env.npy'
...
plt.axhline(y=15, label = 'upper bound', color='b', linestyle = 'dashed')
...
plt.axhline(y=0, label = 'lower bound', color='b', linestyle = 'dashed')
#plt.xlabel("real time [s]")
plt.xlabel("simulated time [s]")
plt.legend()
