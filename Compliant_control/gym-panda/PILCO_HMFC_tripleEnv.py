...
import PILCO_HMFC_utils_tripleEnv as utils
...
save_path = '/home/martin/PILCO/Compliant_panda/trained models/MASTER_THESIS_DualEnv_TRIPLEPol_100Hz' #The folder must already exist!
...
if __name__ == "__main__":
	...
	X1_green,Y1_green, X1_red, Y1_red,T,data_for_plotting = utils.rollout_panda(0,gw, pilco_green=None, pilco_yellow = None, pilco_red=None,random=True, SUBS=SUBS, render=False) # function imported from PILCO (EXAMPLES/UTILS)
	...
	for i in range(1,num_randomised_rollouts):
		...
		X1_green_, Y1_green_, X1_yellow_, Y1_yellow_, X1_red_, Y1_red_, _, data_for_plotting = utils.rollout_panda(i,gw, pilco_green=None, pilco_red=None, random=True, SUBS=SUBS, render=False)
