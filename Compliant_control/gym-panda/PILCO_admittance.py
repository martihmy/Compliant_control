...
if __name__ == "__main__":
	...
	num_rollouts = 2
	save_path = '/home/martin/PILCO/Compliant_panda/trained models/Admittance_master_1sub_2'
	...
	#np.save('/home/martin/Figures master/data from runs/random' + '/admittance_data_dualEnv_.npy',data_for_plotting)
